...
setup(
    ...
    zip_safe=True,
    maintainer='daescastros',
    maintainer_email='daescastros@todo.todo',
    ...
    entry_points={
        'console_scripts': [ # excecutable = node.path:function_name
            ...
            "number_counter = my_py_pkg.z_topics_practice__number_counter:main",
            ...
            "hardware_status_publisher = my_py_pkg.custom_msg_hw_status_publisher:main"
        ],
    },
)
